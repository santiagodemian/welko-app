...
const FAQ_ES: [RegExp, string][] = [
  ...
  [/prueba|demo|gratis/i,           '🎁 Puedes probar el simulador de chat aquí mismo en la página. Para una demo personalizada escríbenos a hello@welko.org.'],
...
const FAQ_EN: [RegExp, string][] = [
  ...
  [/trial|demo|free/i,              '🎁 You can try the chat simulator right here on the page. For a personalized demo, email us at hello@welko.org.'],
...
function getBotReply(input: string, isEN: boolean): string {
  ...
  return isEN
    ? "I'm not sure about that specific question. 😊 For detailed support, write to hello@welko.org or call +52 56 2844 3738. We usually respond in under 2 hours."
    : 'No tengo respuesta exacta para eso 😊. Para soporte detallado escríbenos a hello@welko.org o llámanos al +52 56 2844 3738. Respondemos en menos de 2 horas.'
}
